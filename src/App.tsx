		...
		<div className='App'>
			...
			<header className='App-header'>
				<div className='left-side'>
                    ...
                    ></input> */}
					<br />
					<FormControl label='Province' type='select' selectedItem='Quebec' selectMenu={['Alberta', 'British Columbia', 'Manitoba', 'New Brunswick', 'Newfoundland and Labrador', 'Nova Scotia', 'Nunavut', 'Ontario', 'Prince Edward Island', 'Quebec', 'Saskatchewan', 'Yukon Territories']} />
					{/* <select
                        name="provinces"
					...
					<FormControl
						...
						type='fincancial'
						placeholder='0.0'
						onBlur={(e) => setMonthlyExpenses(Number(e.target.value))}
					/>
					{/* <input
                        placeholder="0"
                        type="number"
				...
				<div className='right-side'>
					{netIncome.monthly > 0 && (
						<label>Your monthly net income is: {netIncome.monthly}</label>
					)}
					<br />
					{netIncome.monthly > 0 && (
						<label>
							Your monthly savings are: {netIncome.monthly - monthlyExpenses}
						</label>
					)}
					<br />
					{netIncome.monthly > 0 && (
					...
					<br />
					{netIncome.monthly > 0 && (
						<label>Your monthly mortgage payments are: {'TBD'}</label>
					)}
				</div>
			</header>
		</div>
